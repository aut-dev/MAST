    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between text-light">
            ...
            <div>
                ...
                <a href="#" :class="{'me-2': true, 'text-light': !store.hideInactiveTasks}" :title="t('Hide inactive tasks')" @click.prevent="store.setHideInactiveTasks(!store.hideInactiveTasks)">
