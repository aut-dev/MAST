            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-check form-switch">
                        ...
                        <label class="form-check-label" for="unlimitedBreak">{{ t("I'm on a unlimited break") }}</label>
                        <div class="form-text">{{ t('All your tasks will be paused until you switch this off') }}</div>
                    </div>
                </div>
