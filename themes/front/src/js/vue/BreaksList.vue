<template>
  <div class="container">
    ...
    <div class="my-3">
      <div class="form-check">
        <input
          ...
          id="showPast"
          @change="changeShowPastBreaks"
          :checked="showPastBreaks"
        />
    ...
    <div class="position-relative">
      ...
      <div
        :class="'row mb-2' + (breakk.past ? ' text-light' : '')"
        v-for="breakk in breaks"
        :key="breakk.id"
      >
        <div class="col-4 pe-1">
          {{ breakk.title }}
        ...
        <div class="col-2 ps-1">
          <a
            ...
            data-bs-toggle="modal"
            class="me-2"
            @click="cloneBreak(breakk)"
          >
            <i class="fa-solid fa-pen-to-square"></i>
          </a>
          <a
            href="#delete-break-modal"
            data-bs-toggle="modal"
            @click="deleteId = breakk.id"
          >
...
export default {
  ...
  created() {
    this.showPastBreaks = parseInt(Cookies.get("showPastBreaks"))
      ? true
      : false;
    this.fetchBreaks();
  },
  methods: {
    fetchBreaks() {
      ...
      axios
        .get(
          "/?action=plugin-users/breaks/get&page=" +
            this.currentPage +
            "&showPast=" +
            (this.showPastBreaks ? 1 : 0),
        )
        .then((data) => {
