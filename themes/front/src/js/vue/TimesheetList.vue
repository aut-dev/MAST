      ...
      <div class="row mt-2 timesheet" v-for="sheet in sheets" :key="sheet.id">
        ...
        <div class="col-6 col-lg-2">
          <a
            ...
            data-bs-toggle="modal"
            class="me-2"
            @click="editedSheet = sheet"
          >
            <i class="fa-solid fa-pen-to-square"></i>
          </a>
          <a
            href="#delete-timesheet-modal"
            data-bs-toggle="modal"
            @click="deleteId = sheet.id"
          >
...
export default {
  ...
  methods: {
    fetchTimeEntries() {
      ...
      axios
        .get(
          "/?action=plugin-timesheets/timesheets/get&id=" +
            this.taskId +
            "&page=" +
            this.currentPage,
        )
